...
<!-- 搜索-->
    <div style="margin: 10px 0;">
      <el-form inline="true" size="small">
        <el-form-item label="团干ID" >
      <el-input v-model="search1" placeholder="请输入团干ID"  clearable>
        ...
        <el-form-item label="所属团委" >
          <el-input v-model="search4" placeholder="请输入团委"  clearable>
            <template #prefix><el-icon class="el-input__icon"><search /></el-icon></template>
          </el-input>
        </el-form-item >
        <el-form-item>
...
<!-- 数据字段-->
    <el-table :data="tableData" stripe border="true"  @selection-change="handleSelectionChange" >
      ...
      <el-table-column prop="id" label="团干ID" sortable />
      <el-table-column prop="role" label="账户类别">
        <template v-slot="scope">
          <el-tag v-if="scope.row.role == 1" type="success">团委管理员</el-tag>
          <el-tag v-else>基层团干</el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="committee" label="所属团委" />
...
<!--    分页-->
    <div style="margin: 10px 0">
      ...
      <el-dialog v-model="dialogVisible" title="编辑团干信息" width="30%">
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item label="所属团委">
            <el-input type="textarea" style="width: 80%" v-model="form.committee"></el-input>
          </el-form-item>
          <el-form-item label="权限编号">
            <el-input type="textarea" style="width: 80%" v-model="form.cmtId"></el-input>
          </el-form-item>
        </el-form>
        <template #footer>
